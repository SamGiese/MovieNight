    ...
    public class DataAccess
    {
        ...
        public List<Person> GetPeople(string lastName)
        {
            ...
            using (IDbConnection connection = new System.Data.SqlClient.SqlConnection(Helper.CnnVal("AdventureWorks2012")))
            {
                ...
                var output = connection.Query<Person>("Person.spPerson_GetInfo @LastName", new { LastName = lastName }).ToList();
                return output;
        ...
        public void InsertPerson(string FirstName, string LastName, string BusinessEntityID, string PersonType)
        {
            using (IDbConnection connection = new System.Data.SqlClient.SqlConnection(Helper.CnnVal("AdventureWorks2012")))
            {
                ...
                people.Add(new Person { FirstName = FirstName, LastName = LastName, BusinessEntityID = BusinessEntityID, PersonType = PersonType });
